                ...
                <div class="col-xl-4 col-lg-5 col-md-7 col-12 mx-auto">
                    <div class="form-ui dt-sl dt-sn pt-4">
                        ...
                        <div class="message-light">
                            اگر قبلا با ایمیل ثبت‌نام کرده‌اید، نیاز به ثبت‌نام مجدد ندارید
                        </div>
                        <form action="<?= URLRoot ?>/user/register" method="post">
                            ...
                            <div class="form-row with-icon">
                                <input type="text"
                                       ...
                                       placeholder="ایمیل خود را وارد نمایید" value="<?= $data['email'] ?>"
                                       name="email">
                            ...
                            <div class="form-row with-icon">
                                <input type="text"
                                       class="input-ui pr-2 <?= !empty($data['username_err']) ? 'border-danger' : '' ?>"
                                       placeholder="نام کاربری" value="<?= $data['username'] ?>" name="username">
                                <i class="mdi mdi-account-circle-outline"></i>
                            </div>
                            <div class="text-danger"><p><?= $data['username_err'] ?></p></div>
                            <!--  end  username input-->
                            ...
                            <div class="form-row with-icon">
                                <input type="password"
                                       class="input-ui pr-2 <?= !empty($data['password_err']) ? 'border-danger' : '' ?>"
                                       placeholder="رمز عبور" value="<?= $data['password'] ?>" name="password">
                                <i class="mdi mdi-lock-outline"></i>
                            </div>
                            <div class="text-danger"><p><?= $data['password_err'] ?></p></div>
                            <!-- end password input -->

                            <!--  start  conpassword input-->
                            <div class="form-row-title">
                                <h3>تایید رمز عبور</h3>
                            </div>
                            <div class="form-row with-icon">
                                <input type="password"
                                       class="input-ui pr-2 <?= !empty($data['confirm_password_err']) ? 'border-danger' : '' ?>"
                                       placeholder="تایید رمز عبور" value="<?= $data['confirm_password'] ?>"
                                       name="confirm_password">
                                <i class="mdi mdi-lock-outline"></i>
                            </div>
                            <div class="text-danger"><p><?= $data['confirm_password_err'] ?></p></div>
                            <!-- end password input -->
                            ...
                            <div class="form-footer text-right mt-3">
                                ...
                                <a href="<?= URLRoot ?>/user/login" class="d-inline-block mr-3 mt-2">وارد شوید</a>
                            </div>
                        </form>
                    </div>
                </div>
