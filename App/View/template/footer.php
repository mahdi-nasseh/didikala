            ...
            <div class="row">
                <div class="service-item col">
                    <a href="#" target="_blank">
                        <img src="<?= AssetsAddress ?>/img/svg/delivery.svg">
                    </a>
                    <p>تحویل اکسپرس</p>
                </div>
                <div class="service-item col">
                    <a href="#" target="_blank">
                        <img src="<?= AssetsAddress ?>/img/svg/contact-us.svg">
                    </a>
                    <p>پشتیبانی 24 ساعته</p>
                </div>
                <div class="service-item col">
                    <a href="#" target="_blank">
                        <img src="<?= AssetsAddress ?>/img/svg/payment-terms.svg">
                    </a>
                    <p>پرداخت درمحل</p>
                </div>
                <div class="service-item col">
                    <a href="#" target="_blank">
                        <img src="<?= AssetsAddress ?>/img/svg/return-policy.svg">
                    </a>
                    <p>۷ روز ضمانت بازگشت</p>
                </div>
                <div class="service-item col">
                    <a href="#" target="_blank">
                        <img src="<?= AssetsAddress ?>/img/svg/origin-guarantee.svg">
                    </a>
        ...
        <div class="container main-container">
            <div class="row">
                ...
                <div class="symbol col-12 col-lg-5">
                    <a href="#" target="_blank"><img src="<?= AssetsAddress ?>/img/symbol-01.png" alt=""></a>
                    <a href="#" target="_blank"><img src="<?= AssetsAddress ?>/img/symbol-02.png" alt=""></a>
                </div>
            </div>
        </div>
    </div>
