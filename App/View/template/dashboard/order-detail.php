...
$order = $data['dashboard_detail_order'];
?>
<!-- Start Content -->
    ...
    <div class="row">
        <div class="col-12">
            <div class="profile-navbar">
                <a href="<?= URLRoot ?>/dashboard/orders" class="profile-navbar-btn-back">بازگشت</a>
                <h4>سفارش <span
                                ...
                                <td>
                                    <div class="details-product-area">
                                        ...
                                        <h5 class="details-product">
                                          <a href="<?= URLRoot ?>/product_list/product/<?= $order_item->products->ID ?>"><span style="height: 50px;"><?= $order_item->products->title ?></span></a>
                                        </h5>
                                    </div>
                                </td>
